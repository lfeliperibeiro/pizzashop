...
export function StoreProfileDialog() {
  ...
  // Aqui estamos usando um conceito chamado optimistic updates, que é uma técnica
  // que consiste em atualizar o cache da aplicação antes de receber a resposta
