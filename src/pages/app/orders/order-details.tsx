...
export function OrderDetails() {
  return (
    <DialogContent>
      <DialogHeader>
        <DialogTitle>Pedido: 27312873128</DialogTitle>
        ...
        <Table>
          <TableBody>
            ...
            <TableRow>
              ...
              <TableCell className="flex justify-end">Felipe Ribeiro</TableCell>
            </TableRow>
            <TableRow>
            ...
            <TableRow>
              ...
              <TableCell className="flex justify-end">há 2 horas</TableCell>
            </TableRow>
          </TableBody>
        </Table>
